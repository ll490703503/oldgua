...
import com.oldold.gua.service.User;
...
public class Usercon {
    ...
    public int addUser(@RequestParam(value = "ID") int id, @RequestParam(value = "Name") String name, String password, Date creatime) {
        com.oldold.gua.domain.User users = new com.oldold.gua.domain.User();
        users.setId(id);
        users.setPassword(password);
        users.setCreatetime(new Date());
        users.setName(name);
        String s = "hahaha";
        int ids = user.addUser(users);
        double x = 9.98D;
    ...
    public PageInfo<com.oldold.gua.domain.User> getAllUser(@RequestParam(value = "pag") int page, int pagesize) {
        ...
        PageInfo<com.oldold.gua.domain.User> userPageInfo = user.getAll(page, pagesize);
